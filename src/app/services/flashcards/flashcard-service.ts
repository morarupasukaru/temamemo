    ...
    flashcards = [
      ...
      },
      {
        ...
        question: [
          ...
          FlashcardItem.buildSound({
            url: 'https://upload.wikimedia.org/wikipedia/commons/transcoded/d/d1/De-at-Kamm.ogg/De-at-Kamm.ogg.mp3',
            mediatype: 'audio/mpeg'})],
        answer: [
          FlashcardItem.buildText({ text: 'der Kamm', centered: true, bigText: true}),
